                    ...
                    <div class="col-lg-6">
                        <div class="banner_content text-center">
                            ...
                            <div class="page_link">
                                ...
                                <a href="course-details1.php">cloud computing</a>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-lg-8 course_details_left">
                    <div class="main_image">
                        <img class="img-fluid" src="img/cloud/c1.jpeg" alt="">
                    </div>
                    <div class="content_wrapper">
                        <h4 class="title">About the COURSE</h4>
                        <div class="content">
                            Chandigarh University, in collaboration with IBM, has become the first university in North India to initiate in a course in Cloud Computing.<br> The course, which has been designed under the guidance of IBM, caters to the growing requirements of professionals who can understand the need to develop applications that can be accessed by users from a public portal. Chandigarh University has this course designed by the University of Engineering. Along with immense learning opportunities, the course also helps students in exploring additional avenues in the IT sector.
                        </div>
                    ...
                    <ul>
                        <li>
                            <a class="justify-content-between d-flex" href="#">
                                <p>Coordinator</p>
                                <span class="or">Neeru Chauhan</span>
                            </a>
                        </li>
                        <li>
                            <a class="justify-content-between d-flex" href="#">
