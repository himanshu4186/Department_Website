			...
			<section id="main">
				...
				<ul id="container" class="item-list">
					<li class="item web key" >
						<div class="image ">
							<img src="img/images/pic_01.png"  alt="" />
							<div class="hover">
					...
					<li class="item illustration identity">
						<div class="image">
							<img src="img/images/pic_1_1.png"  alt="" />
							<div class="hover">
								<a class="fancybox" rel="gallery1">
									<div class="item-content">
					...
					<li class="item web dtp">
						<div class="image">
							<img src="img/images/pic_02.png"  alt="" />
							<div class="hover">
								<a class="fancybox" rel="gallery1" >
									<div class="item-content">
					...
					<li class="item illustration key">
						<div class="image">
							<img src="img/images/pic_03.png"  alt="" />
							<div class="hover">
								<a class="fancybox" rel="gallery1" >
									<div class="item-content">
					...
					<li class="item web identity">
						<div class="image">
							<img src="img/images/pic_04.png"  alt="" />
							<div class="hover">
								<a class="fancybox" rel="gallery1" >
									<div class="item-content">
					...
					<li class="item dtp identity">
						<div class="image">
							<img src="img/images/pic_05.png"  alt="" />
							<div class="hover">
								<a class="fancybox" rel="gallery1" >
									<div class="item-content">
					...
					<li class="item dtp key">
						<div class="image">
							<img src="img/images/pic_06.png"  alt="" />
							<div class="hover">
								<a class="fancybox" rel="gallery1" >
									<div class="item-content">
										<h4>Notification 7</h4>
										<p>This is raw data</p>
									</div>
								</a>
							</div>
					...
					<li class="item web identity">
						<div class="image">
							<img src="img/images/pic_07.png"  alt="" />
							<div class="hover">
								<a class="fancybox" rel="gallery1" >
									<div class="item-content">
										<h4>Notification 8</h4>
										<p>This is raw data</p>
									</div>
								</a>
							</div>
