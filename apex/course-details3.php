                    ...
                    <div class="col-lg-6">
                        <div class="banner_content text-center">
                            ...
                            <div class="page_link">
                                ...
                                <a href="course-details3.php">Security</a>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-lg-8 course_details_left">
                    <div class="main_image">
                        <img class="img-fluid" src="img/is/i1.jpeg" alt="">
                    </div>
                    <div class="content_wrapper">
                        <h4 class="title">About the COURSE</h4>
                        <div class="content">
                            Chandigarh University has cultivated an environment for the development of data security and management models under the University Institute of Engineering. Collaborating with IBM, the program offers students an opportunity to understand the security issues that now plague the modern day computing architectures all over the world. Moving with the growing times, Chandigarh University has joined hands with IBM and introduced this program with an objective to insert the spirit of innovation and research in this field amongst students. Various resources directly sourced from IBM are made available to students to help them in research and development.<br><br>

The emergence of Data Security has resulted in the opening of various professional avenues for young professionals, creating a market ready for young IT graduates who can understand the risks involved in data security. With lucrative packages, data security has become the new professional direction for many students. Understanding the growing urgency around this field, Chandigarh University has become the first university in Punjab to collaborate with IBM to develop a course in Data Security.
                        </div>

                        <h4 class="title">Eligibility</h4>
                        <div class="content">
                            Preference would be given to student on merit basis in JEE<br>
If you are appearing/ awaiting the results please update your registration status once the result is announced.
                        </div>

                        <h4 class="title">Course Outline</h4>
                        <div class="content">
                           
				<h2>Eligibility & Fee Details - 95000/- INR per semester</h2>
				<p><b>Eligibility</b> - 10+2 with Physics and Mathematics as compulsory subjects along with one of the following subjects: Chemistry / Biotechnology / Computer Science / Biology with at least 60% marks in the aggregate.</p>
...
<div class="scrollable-table cusat-fee">
	<table class="table table-bordered table-hover">
		<thead>
			<tr>
				<th>PARAMETERS</th>
				<th>CUSAT SCHOLARSHIP AMOUNT</th>
				<th>AMOUNT TO PAY AFTER CUSAT SCHOLARSHIP</th>
			</tr>
		</thead>
		<tbody>
			<tr>
				<td>100% of semester fees<br>Top 1% students on the basis of merit</td>
				<td>95000/- INR</td>
				<td>NIL</td>
			</tr>
			<tr>
				<td>50% of semester fees<br>Next 2% students on the basis of merit</td>
				<td>47500/- INR	</td>
				<td>47500/- INR</td>
			</tr>
			<tr>
				<td>25% of semester fees<br>Next 3% students on the basis of merit</td>
				<td>23750/- INR</td>
				<td>71250/- INR</td>
			</tr>
			<tr>
				<td>10% of semester fees<br>Next 4% students on the basis of merit</td>
				<td>9500/- INR</td>
				<td>85500/- INR</td>
			</tr>
		</tbody>
	</table>
	<p>* The students who will score 60% or more marks in CU-SAT will be offered at least 5% scholarship in the course fee.</p>
</div>
				<div class="scrollable-table">
					<table class="table table-bordered table-hover">
						<thead>
						...
						<tbody>
							<tr>
								<td>Uniform Fee (One Time)</td>
								<td>2900/- INR</td>
							</tr>
							<tr>
								<td>Fee Regular Exam (Sem Wise)</td>
								<td>1500/- INR</td>
							</tr>
							<tr>
								<td>Refundable Security (One Time)</td>
								<td>2000/- INR</td>
							</tr>
							<tr>
								<td>CU Fest (Anually)</td>
								<td>500/- INR</td>
							</tr>
							<tr>
								<td>Fresher Party (One Time)</td>
								<td>150/- INR</td>
							</tr>
						</tbody>
					</table>
                    ...
                    <ul>
                        <li>
                            <a class="justify-content-between d-flex" href="#">
                                <p>Coordinator</p>
                                <span class="or">Sheetal Kundra</span>
                            </a>
                        </li>
                        <li>
                            <a class="justify-content-between d-flex" href="#">
